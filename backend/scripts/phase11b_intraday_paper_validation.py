...
async def run_experiment():
    print("==================================================")
    print("PHASE 11B - FRESH INTRADAY REAL-DATA -> PAPER-TRADE VALIDATION")
    print("==================================================")
    ...
    if df.empty:
        ...
        print("BLOCKED — NO FRESH MARKET DATA")
        db.close()
        return
    ...
    # Check freshness (assume 1 hour max stale for validation)
